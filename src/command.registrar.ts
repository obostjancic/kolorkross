...
export class CommandRegistrar {
  ...
  public register(): void {
    ...
    this.subs.push(VSCode.registerCommand(cmd.UPDATE_GROUP_ORDER, this.cmdService.updateGroupOrder));
    ...
    this.subs.push(VSCode.registerCommand(cmd.UPDATE_PROJECT_ORDER, this.cmdService.updateProjectOrder));
