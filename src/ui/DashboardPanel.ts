...
export class DashboardPanel {
  ...
  private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, deps: any) {
    this._panel = panel;
  ...
  public async setContent(extensionUri: vscode.Uri) {
  ...
  public static async render(extensionUri: vscode.Uri, deps: any) {
    if (DashboardPanel.currentPanel) {
      ...
      await DashboardPanel.currentPanel.setContent(extensionUri);
    }
  }
